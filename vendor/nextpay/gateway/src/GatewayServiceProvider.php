...
class GatewayServiceProvider extends ServiceProvider
{
	...
	public function boot()
	{
		...
		//php artisan vendor:publish --provider=NextPay\Gateway\GatewayServiceProvider --tag=config
		$this->publishes([
			$config => config_path('gateway.php'),
		], 'config');

		// php artisan vendor:publish --provider=NextPay\Gateway\GatewayServiceProvider --tag=migrations
		$this->publishes([
